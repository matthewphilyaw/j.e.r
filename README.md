...
J.E.R is a fictitious processor family. The intent of this project is to provide a VM that models/approximates micro-controllers. 

Goals:

- [ ] In Browser code editor/file management (using browser local storage)
- [ ] Generated `assembly` parser utilizing nearley.js
